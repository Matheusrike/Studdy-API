/*
  ...
  - You are about to drop the `Relationship_teacher_subject` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `Relationship_teacher_subject_class` table. If the table is not empty, all the data it contains will be lost.
...
*/
-- DropForeignKey
ALTER TABLE `Alternative` DROP FOREIGN KEY `Alternative_question_id_fkey`;

-- DropForeignKey
ALTER TABLE `Question` DROP FOREIGN KEY `Question_quiz_id_fkey`;

-- DropForeignKey
ALTER TABLE `Question_images` DROP FOREIGN KEY `Question_images_question_id_fkey`;

-- DropForeignKey
ALTER TABLE `Question_response` DROP FOREIGN KEY `Question_response_marked_alternative_id_fkey`;

-- DropForeignKey
ALTER TABLE `Question_response` DROP FOREIGN KEY `Question_response_question_id_fkey`;

-- DropForeignKey
ALTER TABLE `Question_response` DROP FOREIGN KEY `Question_response_quiz_attempt_id_fkey`;

-- DropForeignKey
ALTER TABLE `Quiz` DROP FOREIGN KEY `Quiz_teacher_subject_class_id_fkey`;

-- DropForeignKey
ALTER TABLE `Quiz_attempt` DROP FOREIGN KEY `Quiz_attempt_quiz_id_fkey`;

-- DropForeignKey
ALTER TABLE `Quiz_attempt` DROP FOREIGN KEY `Quiz_attempt_student_id_fkey`;

-- DropForeignKey
ALTER TABLE `Relationship_teacher_subject` DROP FOREIGN KEY `Relationship_teacher_subject_subject_id_fkey`;

-- DropForeignKey
ALTER TABLE `Relationship_teacher_subject` DROP FOREIGN KEY `Relationship_teacher_subject_teacher_id_fkey`;

-- DropForeignKey
ALTER TABLE `Relationship_teacher_subject_class` DROP FOREIGN KEY `Relationship_teacher_subject_class_class_id_fkey`;

-- DropForeignKey
ALTER TABLE `Relationship_teacher_subject_class` DROP FOREIGN KEY `Relationship_teacher_subject_class_teacher_subject_id_fkey`;
...
-- DropTable
DROP TABLE `Relationship_teacher_subject`;

-- DropTable
DROP TABLE `Relationship_teacher_subject_class`;
